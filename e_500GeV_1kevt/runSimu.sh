...
# o2-sim (parallel) or o2-sim-serial (sequencial)
...
cmd=$(printf "o2-sim -m FOC --detectorList ALICE2.1 -n %d -g external --seed %d --configKeyValues \"%s\" &> o2sim.log" $NEVENTS $SEED $CONFIGKEYVALUES)
